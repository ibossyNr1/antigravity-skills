...
description: >-
  Facilitate productive team retrospectives with structured formats and
  actionable improvement outcomes
category: project
complexity: simple
version: 1.0.0
...
2. Review retro norms:
   ...
   - Assume good intent
3. Brief check-in: One word to describe sprint
4. Review previous action items (were they done?)
