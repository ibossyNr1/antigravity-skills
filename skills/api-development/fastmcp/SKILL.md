...
name: fastmcp
description: >-
  Build MCP servers in Python with FastMCP framework to expose tools, resources,
  and prompts to LLMs. Supports
  ...
  storage backends for tokens/cache, adding middleware for logging/rate
  limiting, deploying to FastMCP Cloud,
  ...
  lifespan, fastmcp middleware, fastmcp oauth proxy, server composition mcp,
