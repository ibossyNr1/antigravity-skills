...
description: >
  Configure cross validation setup operations. Auto-activating skill for ML
  Training.

  Triggers on: cross validation setup, cross validation setup

  Part of the ML Training skill category. Use when working with cross validation
  setup functionality. Trigger with phrases like "cross validation setup",
  "cross setup", "cross".
allowed-tools:
