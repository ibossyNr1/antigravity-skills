...
description: >
  Configure canary deployment setup operations. Auto-activating skill for ML
  Deployment.
  ...
  services. Trigger with phrases like "canary deployment setup", "canary setup",
  "deploy canary ment setup".
allowed-tools:
