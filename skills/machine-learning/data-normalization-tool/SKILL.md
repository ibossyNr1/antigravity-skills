...
description: >
  Process data normalization tool operations. Auto-activating skill for ML
  Training.
  ...
  normalization tool functionality. Trigger with phrases like "data
  normalization tool", "data tool", "data".
allowed-tools:
