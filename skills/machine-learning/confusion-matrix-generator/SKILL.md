...
description: >
  Generate confusion matrix generator operations. Auto-activating skill for ML
  Training.

  Triggers on: confusion matrix generator, confusion matrix generator

  Part of the ML Training skill category. Use when working with confusion matrix
  generator functionality. Trigger with phrases like "confusion matrix
  generator", "confusion generator", "confusion".
allowed-tools:
