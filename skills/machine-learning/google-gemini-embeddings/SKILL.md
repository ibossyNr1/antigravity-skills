...
description: >
  Build RAG systems, semantic search, and document clustering with Gemini
  embeddings API (gemini-embedding-001). Generate 768-3072 dimension embeddings
  for vector search, integrate with Cloudflare Vectorize, and use 8 task types
  ...
  Vectorize, optimizing dimension sizes (128-3072), or troubleshooting dimension
