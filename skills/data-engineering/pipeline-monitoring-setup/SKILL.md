...
description: >
  Configure pipeline monitoring setup operations. Auto-activating skill for Data
  Pipelines.

  Triggers on: pipeline monitoring setup, pipeline monitoring setup

  Part of the Data Pipelines skill category. Use when monitoring systems or
  services. Trigger with phrases like "pipeline monitoring setup", "pipeline
  setup", "pipeline".
allowed-tools:
