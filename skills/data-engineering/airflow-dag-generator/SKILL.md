...
description: >
  Generate airflow dag generator operations. Auto-activating skill for Data
  Pipelines.

  Triggers on: airflow dag generator, airflow dag generator

  Part of the Data Pipelines skill category. Use when working with airflow dag
  generator functionality. Trigger with phrases like "airflow dag generator",
  "airflow generator", "airflow".
allowed-tools:
