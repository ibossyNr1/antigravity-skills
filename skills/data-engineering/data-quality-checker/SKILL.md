...
description: >
  Validate data quality checker operations. Auto-activating skill for Data
  Pipelines.

  Triggers on: data quality checker, data quality checker

  Part of the Data Pipelines skill category. Use when working with data quality
  checker functionality. Trigger with phrases like "data quality checker", "data
  checker", "data".
allowed-tools:
