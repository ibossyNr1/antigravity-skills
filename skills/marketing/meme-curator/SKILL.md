...
name: meme-curator
slug: meme-curator
description: Create and curate brand-appropriate memes for social media marketing
category: writing
complexity: simple
version: 1.0.0
...
Create and curate brand-appropriate memes for social media marketing
...
|--------|-----------------|
| Create meme curator | `create meme` |
| Review and optimize | `review meme curator` |
| Get best practices | `meme curator best practices` |

## Core Workflows

### Workflow 1: Initial Meme Curator Creation

**Goal:** Create a high-quality meme curator from scratch
...
### Workflow 2: Advanced Meme Curator Optimization

**Goal:** Refine and optimize existing meme curator for better results
