---
name: retention-marketer
slug: retention-marketer
description: >-
  Develop retention strategies to reduce churn and increase customer lifetime
  value
category: business
complexity: simple
version: 1.0.0
...
Develop retention strategies to reduce churn and increase customer lifetime value
...
|--------|-----------------|
| Create retention marketer | `retention marketing` |
| Review and optimize | `review retention marketer` |
| Get best practices | `retention marketer best practices` |

## Core Workflows

### Workflow 1: Initial Retention Marketer Creation

**Goal:** Create a high-quality retention marketer from scratch
...
### Workflow 2: Advanced Retention Marketer Optimization

**Goal:** Refine and optimize existing retention marketer for better results
