...
name: pmf-analyzer
slug: pmf-analyzer
description: 'Assess product-market fit using frameworks, metrics, and customer signals'
category: business
complexity: simple
version: 1.0.0
...
Assess product-market fit using frameworks, metrics, and customer signals
...
|--------|-----------------|
| Create pmf analyzer | `product market fit` |
| Review and optimize | `review pmf analyzer` |
| Get best practices | `pmf analyzer best practices` |

## Core Workflows

### Workflow 1: Initial PMF Analyzer Creation

**Goal:** Create a high-quality pmf analyzer from scratch
...
### Workflow 2: Advanced PMF Analyzer Optimization

**Goal:** Refine and optimize existing pmf analyzer for better results
