...
description: >
  Configure websocket handler setup operations. Auto-activating skill for
  Backend Development.
  ...
  websocket handler setup functionality. Trigger with phrases like "websocket
  handler setup", "websocket setup", "websocket".
allowed-tools:
