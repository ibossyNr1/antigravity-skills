...
description: >
  Configure with memcached config helper operations. Auto-activating skill for
  Backend Development.

  Triggers on: memcached config helper, memcached config helper

  Part of the Backend Development skill category. Use when configuring systems
  or services. Trigger with phrases like "memcached config helper", "memcached
  helper", "memcached".
allowed-tools:
