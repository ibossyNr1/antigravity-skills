...
description: >
  Configure with sprint planning helper operations. Auto-activating skill for
  Enterprise Workflows.

  Triggers on: sprint planning helper, sprint planning helper

  Part of the Enterprise Workflows skill category. Use when working with sprint
  planning helper functionality. Trigger with phrases like "sprint planning
  helper", "sprint helper", "sprint".
allowed-tools:
