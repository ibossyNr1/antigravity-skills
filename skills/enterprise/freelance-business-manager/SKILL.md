...
slug: freelance-business-manager
description: 'Manage freelance business operations including clients, projects, and finances'
category: business
complexity: simple
version: 1.0.0
...
|--------|-----------------|
| Create freelance business manager | `freelance business` |
| Review and optimize | `review freelance business manager` |
| Get best practices | `freelance business manager best practices` |

## Core Workflows

### Workflow 1: Initial Freelance Business Manager Creation

**Goal:** Create a high-quality freelance business manager from scratch
...
### Workflow 2: Advanced Freelance Business Manager Optimization

**Goal:** Refine and optimize existing freelance business manager for better results
