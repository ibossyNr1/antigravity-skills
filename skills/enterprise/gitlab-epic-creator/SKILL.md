...
description: >
  Create gitlab epic creator operations. Auto-activating skill for Enterprise
  Workflows.
  ...
  epic creator functionality. Trigger with phrases like "gitlab epic creator",
  "gitlab creator", "gitlab".
allowed-tools:
