...
description: >
  Create github issue creator operations. Auto-activating skill for Enterprise
  Workflows.

  Triggers on: github issue creator, github issue creator

  Part of the Enterprise Workflows skill category. Use when working with github
  issue creator functionality. Trigger with phrases like "github issue creator",
