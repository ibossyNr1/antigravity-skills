...
description: >
  Create webhook sender creator operations. Auto-activating skill for API
  Integration.
  ...
  sender creator functionality. Trigger with phrases like "webhook sender
  creator", "webhook creator", "webhook".
allowed-tools:
