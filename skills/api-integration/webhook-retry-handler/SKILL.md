...
description: >
  Manage webhook retry handler operations. Auto-activating skill for API
  Integration.
  ...
  retry handler functionality. Trigger with phrases like "webhook retry
  handler", "webhook handler", "webhook".
allowed-tools:
