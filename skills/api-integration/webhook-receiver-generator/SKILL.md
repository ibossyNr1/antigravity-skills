...
description: >
  Generate webhook receiver generator operations. Auto-activating skill for API
  Integration.
  ...
  receiver generator functionality. Trigger with phrases like "webhook receiver
  generator", "webhook generator", "webhook".
allowed-tools:
