...
description: >
  Build React Native 0.76+ apps with Expo SDK 52. Covers mandatory New
  Architecture (0.82+), React 19 changes (propTypes/forwardRef removal), new CSS
...
metadata:
  keywords: >-
    ...
    swift-template, expo-sdk-52, hermes, devtools, mixBlendMode,
    display-contents, outline, propTypes, forwardRef, android-xml-drawables
version: 1.0.0
