...
description: >
  ...
  Part of the Frontend Development skill category. Use when working with color
  contrast checker functionality. Trigger with phrases like "color contrast
  checker", "color checker", "color".
allowed-tools:
