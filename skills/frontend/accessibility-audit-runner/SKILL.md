...
description: >
  Run accessibility audit runner operations. Auto-activating skill for Frontend
  Development.
  ...
  auditing accessibility audit runner. Trigger with phrases like "accessibility
  audit runner", "accessibility runner", "accessibility".
allowed-tools:
