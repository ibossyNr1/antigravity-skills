...
description: >
  Analyze bundle size analyzer operations. Auto-activating skill for Frontend
  Development.
  ...
  auditing bundle size analyzer. Trigger with phrases like "bundle size
  analyzer", "bundle analyzer", "analyze bundle size r".
allowed-tools:
