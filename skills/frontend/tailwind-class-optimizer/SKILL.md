...
description: >
  Optimize tailwind class optimizer operations. Auto-activating skill for
  ...
  tailwind class optimizer functionality. Trigger with phrases like "tailwind
  class optimizer", "tailwind optimizer", "tailwind".
allowed-tools:
