...
description: >
  Configure cloud tasks queue setup operations. Auto-activating skill for GCP
  Skills.

  Triggers on: cloud tasks queue setup, cloud tasks queue setup

  Part of the GCP Skills skill category. Use when working with cloud tasks queue
  setup functionality. Trigger with phrases like "cloud tasks queue setup",
  "cloud setup", "cloud".
allowed-tools:
