...
description: >
  Create cloud scheduler job creator operations. Auto-activating skill for GCP
  Skills.

  Triggers on: cloud scheduler job creator, cloud scheduler job creator

  Part of the GCP Skills skill category. Use when working with cloud scheduler
  job creator functionality. Trigger with phrases like "cloud scheduler job
  creator", "cloud creator", "cloud".
allowed-tools:
  - 'Read, Write, Edit, Bash(gcloud:*)'
version: 1.0.0
