...
name: founder-coach
slug: founder-coach
description: 'Support founder mental health, decision-making, and leadership challenges'
category: personal
complexity: simple
version: 1.0.0
...
Support founder mental health, decision-making, and leadership challenges
...
**Not recommended for:**
- Tasks requiring business strategy
- team coordination
...
|--------|-----------------|
| Create founder coach | `founder coaching` |
| Review and optimize | `review founder coach` |
| Get best practices | `founder coach best practices` |

## Core Workflows

### Workflow 1: Initial Founder Coach Creation

**Goal:** Create a high-quality founder coach from scratch
...
### Workflow 2: Advanced Founder Coach Optimization

**Goal:** Refine and optimize existing founder coach for better results
...
2. **Follow Industry Standards**
   Leverage proven frameworks and best practices in personal.
...
- **Tools**: Integration with common personal platforms and tools
- **Workflows**: Fits into existing personal productivity workflows
- **Team**: Collaborates with individual contributors stakeholders
