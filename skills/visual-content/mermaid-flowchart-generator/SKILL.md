...
description: >
  Generate mermaid flowchart generator operations. Auto-activating skill for
  Visual Content.
  ...
  flowchart generator functionality. Trigger with phrases like "mermaid
  flowchart generator", "mermaid generator", "mermaid".
allowed-tools:
