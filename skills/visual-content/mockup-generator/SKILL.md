...
description: Create realistic product mockups and presentations
category: design
complexity: simple
version: 1.0.0
...
- **Choose appropriate context**: Match mockup style to brand personality
- **Use realistic scenarios**: Show product in believable situations
- **Mind the details**: Quality of mockup reflects on design quality
- **Consistent lighting**: Maintain cohesive look across mockup set
- **Proper scale**: Ensure product/screen proportions are accurate
- **High resolution**: Always create at publication quality (min 2000px)
- **Consider perspective**: Angle should complement design, not compete
- **Background matters**: Support the product, don't distract
- **Show in context**: Help viewer understand use case
- **Create variations**: Multiple angles tell fuller story
- **Test readability**: Ensure text/design visible at display size
- **Brand consistency**: Mockups should align with brand aesthetic

## Technical Specifications

### Screen Resolutions for Mockups
...
**Mobile (Portrait)**
- iPhone: 1170x2532 (iPhone 14 Pro)
- Android: 1080x2400 (common flagship)
...
**For web/social**: JPG or PNG (PNG for transparency)
**For print**: PDF or high-res PNG (300 DPI minimum)
**For presentations**: PNG with transparency
**For video**: PNG sequence or MP4

### File Sizes

- Social media: 1-5MB max
- Website hero: 200-500KB (optimized)
- Print materials: Full resolution, no size limit
- Presentations: 500KB-1MB per image
...
## Popular Mockup Resources

**Free Mockup Tools**
- Artboard Studio: Browser-based, easy
- Mockuper: Simple device mockups
- Facebook Design: Free device templates
- Screely: Instant browser mockups

**Premium Mockup Tools**
- Rotato: Animated 3D device mockups
- Mediamodifier: Huge mockup library
- Placeit: Templates for everything
- Smartmockups: Easy drag-and-drop

**Create with Midjourney** (Recommended)
- Most flexible
- Unique, custom scenes
- Perfect brand alignment
- Unlimited variations

## Tools Integration

- Use **Midjourney** to generate all mockup backgrounds and contexts
- Use **Playwright** to capture actual product screenshots for mockups
- Use **ui-builder** to create the designs being mocked up
- Use **brand-identity-builder** to ensure mockups align with brand

## Common Requests

**SaaS Product**: Desktop browser + mobile app in clean office setting
**Mobile App**: iPhone in hand, lifestyle outdoor setting
**E-commerce**: Product packaging on textured surface with props
**Portfolio**: Multi-device responsive showcase on desk
**Brand Launch**: Flat lay of business cards, letterhead, and merch
**Social Media**: Instagram-ready post with phone mockup and props
