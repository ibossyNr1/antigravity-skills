...
slug: engagement-optimizer
description: Optimize social media engagement through comment strategies and DM automation
category: business
complexity: simple
version: 1.0.0
...
|--------|-----------------|
| Create engagement optimizer | `engagement optimization` |
| Review and optimize | `review engagement optimizer` |
| Get best practices | `engagement optimizer best practices` |

## Core Workflows

### Workflow 1: Initial Engagement Optimizer Creation

**Goal:** Create a high-quality engagement optimizer from scratch
...
### Workflow 2: Advanced Engagement Optimizer Optimization

**Goal:** Refine and optimize existing engagement optimizer for better results
