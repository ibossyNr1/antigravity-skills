...
slug: exit-strategist
description: 'Plan M&A exits, prepare for acquisition, and maximize exit value'
category: business
complexity: simple
version: 1.0.0
...
|--------|-----------------|
| Create exit strategist | `exit strategy` |
| Review and optimize | `review exit strategist` |
| Get best practices | `exit strategist best practices` |

## Core Workflows

### Workflow 1: Initial Exit Strategist Creation

**Goal:** Create a high-quality exit strategist from scratch
...
### Workflow 2: Advanced Exit Strategist Optimization

**Goal:** Refine and optimize existing exit strategist for better results
