...
description: >-
  Analyze VC term sheets, understand key terms, and negotiate favorable
  conditions
category: business
complexity: simple
version: 1.0.0
...
|--------|-----------------|
| Create term sheet analyzer | `term sheet` |
| Review and optimize | `review term sheet analyzer` |
| Get best practices | `term sheet analyzer best practices` |

## Core Workflows

### Workflow 1: Initial Term Sheet Analyzer Creation

**Goal:** Create a high-quality term sheet analyzer from scratch
...
### Workflow 2: Advanced Term Sheet Analyzer Optimization

**Goal:** Refine and optimize existing term sheet analyzer for better results
