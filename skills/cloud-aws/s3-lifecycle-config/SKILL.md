...
description: >
  Configure s3 lifecycle config operations. Auto-activating skill for AWS
  Skills.

  Triggers on: s3 lifecycle config, s3 lifecycle config

  Part of the AWS Skills skill category. Use when configuring systems or
  services. Trigger with phrases like "s3 lifecycle config", "s3 config", "s3".
allowed-tools:
