...
description: >
  Manage route53 record manager operations. Auto-activating skill for AWS
  Skills.

  Triggers on: route53 record manager, route53 record manager

  Part of the AWS Skills skill category. Use when working with route53 record
  manager functionality. Trigger with phrases like "route53 record manager",
  "route53 manager", "route53".
allowed-tools:
