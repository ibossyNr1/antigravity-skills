...
description: >
  Generate s3 bucket policy generator operations. Auto-activating skill for AWS
  Skills.

  Triggers on: s3 bucket policy generator, s3 bucket policy generator

  Part of the AWS Skills skill category. Use when working with s3 bucket policy
  generator functionality. Trigger with phrases like "s3 bucket policy
  generator", "s3 generator", "s3".
allowed-tools:
