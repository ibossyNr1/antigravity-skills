...
description: >
  Manage terraform state manager operations. Auto-activating skill for DevOps
  Advanced.
  ...
  state manager functionality. Trigger with phrases like "terraform state
  manager", "terraform manager", "terraform".
allowed-tools:
