...
name: kubectl-skill
description: >-
  Execute and manage Kubernetes clusters via kubectl commands. Query resources,
...
compatibility: >-
  Requires kubectl binary (v1.20+) and active kubeconfig connection to a
  Kubernetes cluster. Works on macOS, Linux, and Windows (WSL).
version: 1.0.0
---
