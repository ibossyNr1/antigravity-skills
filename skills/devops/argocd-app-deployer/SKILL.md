...
description: >
  Deploy argocd app deployer operations. Auto-activating skill for DevOps
  Advanced.
  ...
  services. Trigger with phrases like "argocd app deployer", "argocd deployer",
  "deploy argocd app er".
allowed-tools:
