...
description: >
  ...
  Part of the DevOps Basics skill category. Use when working with changelog
  creator functionality. Trigger with phrases like "changelog creator",
  "changelog creator", "changelog".
allowed-tools:
