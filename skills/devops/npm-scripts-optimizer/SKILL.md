...
description: >
  Optimize npm scripts optimizer operations. Auto-activating skill for DevOps
  Basics.

  Triggers on: npm scripts optimizer, npm scripts optimizer

  Part of the DevOps Basics skill category. Use when working with npm scripts
  optimizer functionality. Trigger with phrases like "npm scripts optimizer",
  "npm optimizer", "npm".
allowed-tools:
