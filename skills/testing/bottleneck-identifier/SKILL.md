...
description: >
  Execute bottleneck identifier operations. Auto-activating skill for
  Performance Testing.
  ...
  bottleneck identifier functionality. Trigger with phrases like "bottleneck
  identifier", "bottleneck identifier", "bottleneck".
allowed-tools:
