...
description: >
  Analyze coverage report analyzer operations. Auto-activating skill for Test
  Automation.

  Triggers on: coverage report analyzer, coverage report analyzer

  Part of the Test Automation skill category. Use when analyzing or auditing
  coverage report analyzer. Trigger with phrases like "coverage report
  analyzer", "coverage analyzer", "analyze coverage report r".
allowed-tools:
