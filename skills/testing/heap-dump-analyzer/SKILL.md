...
description: >
  Analyze heap dump analyzer operations. Auto-activating skill for Performance
  Testing.
  ...
  heap dump analyzer. Trigger with phrases like "heap dump analyzer", "heap
  analyzer", "analyze heap dump r".
allowed-tools:
