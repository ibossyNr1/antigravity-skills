...
description: >
  Profile database query profiler operations. Auto-activating skill for
  Performance Testing.

  Triggers on: database query profiler, database query profiler

  Part of the Performance Testing skill category. Use when working with database
  query profiler functionality. Trigger with phrases like "database query
  profiler", "database profiler", "database".
allowed-tools:
