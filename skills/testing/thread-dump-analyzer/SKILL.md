...
description: >
  Analyze thread dump analyzer operations. Auto-activating skill for Performance
  Testing.
  ...
  thread dump analyzer. Trigger with phrases like "thread dump analyzer",
  "thread analyzer", "analyze thread dump r".
allowed-tools:
