...
description: >
  Analyze percentile analyzer operations. Auto-activating skill for Performance
  Testing.
  ...
  percentile analyzer. Trigger with phrases like "percentile analyzer",
  "percentile analyzer", "analyze percentile r".
allowed-tools:
