...
description: >
  Create benchmark suite creator operations. Auto-activating skill for
  Performance Testing.
  ...
  benchmark suite creator functionality. Trigger with phrases like "benchmark
  suite creator", "benchmark creator", "benchmark".
allowed-tools:
