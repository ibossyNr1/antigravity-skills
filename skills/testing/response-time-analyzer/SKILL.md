...
description: >
  Analyze response time analyzer operations. Auto-activating skill for
  Performance Testing.
  ...
  response time analyzer. Trigger with phrases like "response time analyzer",
  "response analyzer", "analyze response time r".
allowed-tools:
