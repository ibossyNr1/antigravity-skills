...
triggers:
  - >-
    When you need to send personalized emails with images based on data stored
    in Airtable.
  - >-
    When you want to automate the process of creating email drafts for
    leads/contacts in Airtable.
allowed-tools: []
