...
name: better-auth
description: >
  Build authentication systems for TypeScript/Cloudflare Workers with social
...
metadata:
  ...
  breaking_changes: >-
    v1.4.0 - ESM-only (Nov 2025), v1.3 - Multi-team table changes (July 2025),
    v2.0.0 - D1 adapter patterns (Drizzle/Kysely required)
  keywords:
    - better-auth
    - authentication
    - cloudflare-d1
