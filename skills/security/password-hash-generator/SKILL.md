...
description: >
  Generate password hash generator operations. Auto-activating skill for
  ...
  password hash generator functionality. Trigger with phrases like "password
  hash generator", "password generator", "password".
allowed-tools:
