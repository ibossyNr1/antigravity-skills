...
description: >
  Configure with oauth2 flow helper operations. Auto-activating skill for
  Security Fundamentals.

  Triggers on: oauth2 flow helper, oauth2 flow helper

  Part of the Security Fundamentals skill category. Use when working with oauth2
  flow helper functionality. Trigger with phrases like "oauth2 flow helper",
  "oauth2 helper", "oauth2".
allowed-tools:
