...
description: >
  Validate session security checker operations. Auto-activating skill for
  ...
  session security checker functionality. Trigger with phrases like "session
  security checker", "session checker", "session".
allowed-tools:
