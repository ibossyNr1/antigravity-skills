...
description: >
  Generate changelog generator operations. Auto-activating skill for Technical
  Documentation.
  ...
  changelog generator functionality. Trigger with phrases like "changelog
  generator", "changelog generator", "changelog".
allowed-tools:
