...
description: >
  Manage incident postmortem template operations. Auto-activating skill for
  ...
  incident postmortem template functionality. Trigger with phrases like
  "incident postmortem template", "incident template", "incident".
allowed-tools:
