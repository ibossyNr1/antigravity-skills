...
description: >
  Generate jsdoc comment generator operations. Auto-activating skill for
  ...
  jsdoc comment generator functionality. Trigger with phrases like "jsdoc
  comment generator", "jsdoc generator", "jsdoc".
allowed-tools:
