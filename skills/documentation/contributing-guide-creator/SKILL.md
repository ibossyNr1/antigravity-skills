...
description: >
  Create contributing guide creator operations. Auto-activating skill for
  ...
  contributing guide creator functionality. Trigger with phrases like
  "contributing guide creator", "contributing creator", "contributing".
allowed-tools:
