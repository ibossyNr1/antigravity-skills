...
description: >
  Generate release notes generator operations. Auto-activating skill for
  ...
  release notes generator functionality. Trigger with phrases like "release
  notes generator", "release generator", "release".
allowed-tools:
