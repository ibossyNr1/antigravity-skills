...
description: >
  Create architecture doc creator operations. Auto-activating skill for
  ...
  architecture doc creator functionality. Trigger with phrases like
  "architecture doc creator", "architecture creator", "architecture".
allowed-tools:
