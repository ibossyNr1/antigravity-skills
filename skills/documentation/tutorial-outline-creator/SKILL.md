...
description: >
  Create tutorial outline creator operations. Auto-activating skill for
  ...
  tutorial outline creator functionality. Trigger with phrases like "tutorial
  outline creator", "tutorial creator", "tutorial".
allowed-tools:
