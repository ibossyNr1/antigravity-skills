...
description: >
  Generate mkdocs config generator operations. Auto-activating skill for
  ...
  systems or services. Trigger with phrases like "mkdocs config generator",
  "mkdocs generator", "mkdocs".
allowed-tools:
