...
description: >
  ...
  Auto-activating skill for Data Analytics.

  Triggers on: retention calculator, retention calculator

  Part of the Data Analytics skill category. Use when working with retention
  calculator functionality. Trigger with phrases like "retention calculator",
  "retention calculator", "retention".
allowed-tools:
