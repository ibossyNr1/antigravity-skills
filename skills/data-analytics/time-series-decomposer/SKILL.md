...
description: >
  Manage time series decomposer operations. Auto-activating skill for Data
  Analytics.

  Triggers on: time series decomposer, time series decomposer

  Part of the Data Analytics skill category. Use when working with time series
  decomposer functionality. Trigger with phrases like "time series decomposer",
  "time decomposer", "time".
allowed-tools:
