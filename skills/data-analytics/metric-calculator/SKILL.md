...
description: >
  Configure and manage - Calculate metric calculator operations. Auto-activating
  skill for Data Analytics.

  Triggers on: metric calculator, metric calculator

  Part of the Data Analytics skill category. Use when working with metric
  calculator functionality. Trigger with phrases like "metric calculator",
