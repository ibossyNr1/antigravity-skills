...
description: >
  Build funnel analysis builder operations. Auto-activating skill for Data
  Analytics.

  Triggers on: funnel analysis builder, funnel analysis builder

  Part of the Data Analytics skill category. Use when working with funnel
  analysis builder functionality. Trigger with phrases like "funnel analysis
