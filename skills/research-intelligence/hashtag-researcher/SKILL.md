...
slug: hashtag-researcher
description: >-
  Research and strategize hashtag usage for maximum social media reach and
  discovery
category: research
complexity: simple
version: 1.0.0
...
|--------|-----------------|
| Create hashtag researcher | `hashtag research` |
| Review and optimize | `review hashtag researcher` |
| Get best practices | `hashtag researcher best practices` |

## Core Workflows

### Workflow 1: Initial Hashtag Researcher Creation

**Goal:** Create a high-quality hashtag researcher from scratch
...
### Workflow 2: Advanced Hashtag Researcher Optimization

**Goal:** Refine and optimize existing hashtag researcher for better results
