...
description: 'Manage bibliographies, citations, and academic references in multiple formats'
category: writing
complexity: simple
version: 1.0.0
...
|--------|-----------------|
| Create citation manager | `citations` |
| Review and optimize | `review citation manager` |
| Get best practices | `citation manager best practices` |

## Core Workflows

### Workflow 1: Initial Citation Manager Creation

**Goal:** Create a high-quality citation manager from scratch
...
### Workflow 2: Advanced Citation Manager Optimization

**Goal:** Refine and optimize existing citation manager for better results
