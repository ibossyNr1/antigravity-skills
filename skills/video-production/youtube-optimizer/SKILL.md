...
slug: youtube-optimizer
description: >-
  Optimize YouTube videos for SEO, thumbnails, descriptions, and audience
  retention
category: writing
complexity: simple
version: 1.0.0
...
|--------|-----------------|
| Create youtube optimizer | `youtube optimization` |
| Review and optimize | `review youtube optimizer` |
| Get best practices | `youtube optimizer best practices` |

## Core Workflows

### Workflow 1: Initial YouTube Optimizer Creation

**Goal:** Create a high-quality youtube optimizer from scratch
...
### Workflow 2: Advanced YouTube Optimizer Optimization

**Goal:** Refine and optimize existing youtube optimizer for better results
