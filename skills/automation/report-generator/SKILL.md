...
description: >
  Generate report generator operations. Auto-activating skill for Business
  Automation.

  Triggers on: report generator, report generator

  Part of the Business Automation skill category. Use when working with report
  generator functionality. Trigger with phrases like "report generator", "report
  generator", "report".
allowed-tools:
