...
description: >
  Create calendar event creator operations. Auto-activating skill for Business
  Automation.

  Triggers on: calendar event creator, calendar event creator

  Part of the Business Automation skill category. Use when working with calendar
  event creator functionality. Trigger with phrases like "calendar event
