---
name: retainer-structurer
slug: retainer-structurer
description: >-
  Structure retainer packages and recurring revenue models for service
  businesses
category: business
complexity: simple
version: 1.0.0
...
|--------|-----------------|
| Create retainer structurer | `retainer structure` |
| Review and optimize | `review retainer structurer` |
| Get best practices | `retainer structurer best practices` |

## Core Workflows

### Workflow 1: Initial Retainer Structurer Creation

**Goal:** Create a high-quality retainer structurer from scratch
...
### Workflow 2: Advanced Retainer Structurer Optimization

**Goal:** Refine and optimize existing retainer structurer for better results
