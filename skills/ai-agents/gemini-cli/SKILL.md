...
name: gemini-cli
description: >-
  Consult Google Gemini CLI for second opinions on architecture, debugging, and
  security audits. Use Gemini's 1M+
  ...
  sensitive code, planning refactors (5+ files), approaching 70%+ context
  capacity, unfamiliar with tech stack,
  ...
  audit gemini, 1M context window, AI pair programming, gemini consultation,
...
metadata:
  ...
  last_verified: 2025-11-19T00:00:00.000Z
  token_savings: ~60-70%
  errors_prevented: 6+
