...
description: >-
  Talk to your Garmin data naturally - "what was my fastest speed
  snowboarding?", "how did I sleep last night?", "what was my heart rate at
  3pm?". Access 20+ metrics (sleep stages, Body Battery, HRV, VO2 max, training
  readiness, body composition, SPO2), download FIT/GPX files for route analysis,
  query elevation/pace at any point, and generate interactive health dashboards.
  ...
  clawdbot:
    ...
    install:
      ...
      - id: fitparse
        kind: python
        package: fitparse
        label: Install fitparse (pip)
      - id: gpxpy
        kind: python
        package: gpxpy
        label: Install gpxpy (pip)
