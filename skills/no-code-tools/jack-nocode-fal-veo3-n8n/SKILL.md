...
Automates video creation with Fal AI's Veo 3 using n8n, generating prompts, calling the API, and delivering the video via email.

## Workflow

See the file '___Veo_Automation (1).json'
