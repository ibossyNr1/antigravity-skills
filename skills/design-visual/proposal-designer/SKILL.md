...
description: Create visually compelling proposals that win clients and close deals
category: design
complexity: simple
version: 1.0.0
...
Create visually compelling proposals that win clients and close deals
...
|--------|-----------------|
| Create proposal designer | `design proposal` |
| Review and optimize | `review proposal designer` |
| Get best practices | `proposal designer best practices` |

## Core Workflows

### Workflow 1: Initial Proposal Designer Creation

**Goal:** Create a high-quality proposal designer from scratch
...
### Workflow 2: Advanced Proposal Designer Optimization

**Goal:** Refine and optimize existing proposal designer for better results
