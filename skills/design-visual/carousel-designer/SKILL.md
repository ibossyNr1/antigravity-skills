...
slug: carousel-designer
description: >-
  Design educational carousel posts for Instagram and LinkedIn that inform and
  engage
category: design
complexity: simple
version: 1.0.0
...
|--------|-----------------|
| Create carousel designer | `carousel post` |
| Review and optimize | `review carousel designer` |
| Get best practices | `carousel designer best practices` |

## Core Workflows

### Workflow 1: Initial Carousel Designer Creation

**Goal:** Create a high-quality carousel designer from scratch
...
### Workflow 2: Advanced Carousel Designer Optimization

**Goal:** Refine and optimize existing carousel designer for better results
