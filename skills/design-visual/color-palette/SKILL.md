...
name: color-palette
description: >
  Generate complete, accessible color palettes from a single brand hex. Creates
  11-shade scale (50-950), semantic tokens (background, foreground, card,
...
metadata:
  keywords:
    ...
    - wcag-contrast
    - accessibility
  last_verified: 2026-01-14T00:00:00.000Z
version: 1.0.0
